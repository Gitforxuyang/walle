...
import (
	"context"
	utils2 "github.com/Gitforxuyang/walle/util/utils"
	"go.uber.org/zap"
...
func (m *evaLogger) getFields(ctx context.Context, fields Fields) []zap.Field {
	...
	fids = append(fids, zap.Any("timestamp", utils2.FormatTime(time.Now(), "2006-01-02 15:04:05")))
	fids = append(fids, zap.Any("traceId", utils2.GetTraceId(ctx)))
